...
import {
  AlarmSetResult,
  CapacitorAlarmNotificationPlugin,
} from "./definitions";

export class CapacitorAlarmNotificationWeb
  extends WebPlugin
  implements CapacitorAlarmNotificationPlugin
{
  constructor() {
    super({
...
registerPlugin("CapacitorAlarmNotification");
